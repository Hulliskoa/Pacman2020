...
{
protected:
	int normalSpeed = 2;/*!<Normal speed for an moving entity*/
	int speed = normalSpeed;/*!<speed is the same as normal speed on creation*/
	int halfSpeed = normalSpeed / 2;/*!<normalSpeed / 2*/
	int doubleSpeed = normalSpeed * 2;/*!<normalSpeed * 2*/
public:
